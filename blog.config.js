...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Antenna', // 您的昵称 
  BIO: process.env.NEXT_PUBLIC_BIO || 'Antenna 触角', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://antenna.incidental.site/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,营销, 互联网', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Antenna 触角官方博客，为您提供最新的内容营销资讯、实战技巧、案例分析，帮助您提升内容营销水平。',
