...
export default function TouchMeCard() {
  ...
  return (
    <div className={'relative h-28 text-white flex flex-col'}>
      <FlipCard
        className='cursor-pointer lg:p-6 p-4 border rounded-xl bg-[#4f65f0] dark:bg-blue-600 dark:border-gray-600'
        frontContent={
          <div className='h-full'>
            ...
            <div
              ...
              style={{
                background:
                  'url(/images/heo/Frame 2.png) center center no-repeat'
              }}></div>
          </div>
        }
        backContent={
