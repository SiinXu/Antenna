...
To contribute to Antenna, follow these steps:
...
6. [Create a PR][pr] from the branch in your fork to Antenna' `main` branch.
...
If you want to submit your custom theme to Antenna, copy a new folder in
[`themes`][themes-dir] from [`example`][example]. The folder name  will be the
theme's key. 

## Adding localizations

If your language is not yet supported by Antenna, please contribute a
...
Antenna uses environment variables for configuration. To set up your development environment:
